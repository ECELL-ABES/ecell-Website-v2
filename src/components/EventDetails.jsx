...
const EventDetail = () => {
  ...
  return (
    <div className="mt-12 container mx-auto p-8 text-white">
      {/* Event Title */}
      ...
      {/* Event Image */}
      <div className="flex justify-center"> {/* Increased margin-top for more spacing */}
        <img
          src={event.image}
          alt={event.title}
          className="w-full sm:w-11/12 md:w-10/12 lg:w-4/5 xl:w-3/4 rounded-lg shadow-lg"
          style={{
            maxHeight: '600px',  // Reduced the maximum height of the image
      ...
      {/* Event Description */}
      <div className="p-6 mt-8 mx-auto bg-black rounded-lg shadow-lg max-w-5xl">
